...
export default function GalleryPage() {
    // Placeholder gallery - you can add real images later
    const images = Array(12).fill('/logo.webp');
            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {images.map((image, index) => (
                        <div
                            key={index}
                            className="glass-card p-0 overflow-hidden card-hover animate-fadeInUp"
